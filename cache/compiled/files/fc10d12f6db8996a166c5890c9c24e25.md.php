...
return [
    ...
    'filename' => '/home/kincsadv/web/ilyaklishin.ru/public_html/user/pages/01.blog/random-thoughts/item.md',
    'modified' => 1648404688,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Услуги аналитика
date: 13:34 05/26/2014 
description: analysis баз данных и емкости рынка, макро и микро-сегментация, поиск скрытых закономерностей
author: Stephan Douglas
taxonomy:
    category: blog
    tag: [journal]',
        'markdown' => 'Чем довелось заниматься
