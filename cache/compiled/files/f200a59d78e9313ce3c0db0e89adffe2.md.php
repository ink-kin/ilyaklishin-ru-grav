...
return [
    ...
    'filename' => '/home/kincsadv/web/ilyaklishin.ru/public_html/user/pages/01.blog/sunshine-in-the-hills/item.md',
    'modified' => 1648404688,
    'data' => [
        'header' => [
            ...
            'taxonomy' => [
                ...
                'tag' => [
                    ...
                    5 => 'information',
                    6 => 'CRUD',
                    7 => 'record_structure_tags',
                    8 => 'Innovate'
                ]
            ]
        ],
        'frontmatter' => 'title: Данные — это чернила, которыми вы пишите ваш бизнес. 
description: Данные — это чернила, которыми вы пишите ваш бизнес
date: 14:55 11/11/2020
author: ILya Klishin
taxonomy:
    ...
    tag: [data, pathos, paradigm, method, myth, information, CRUD, record_structure_tags, Innovate]',
        'markdown' => 'Одна из самых важных вещей, которые нужно делать на современном предприятии, — это собирать знания о компании. 
