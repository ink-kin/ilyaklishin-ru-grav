...
class __TwigTemplate_af67756332c3cf7f3d6b415206698734c956e1db9e3c974b7db9c277501e9840 extends \Twig\Template
{
                ...
                if ($this->getAttribute($context["field"], "fields", [])) {
                    ...
                    if (($context["show_field"] ?? null)) {
                        ...
                        if (($context["value"] ?? null)) {
                            ...
                            echo ": ";
                            echo twig_escape_filter($this->env, ($this->env->getExtension('Grav\Common\Twig\Extension\GravExtension')->stringFilter(((twig_test_iterable(($context["value"] ?? null))) ? (twig_jsonencode_filter(($context["value"] ?? null))) : (($context["value"] ?? null)))) . "
"), "html", null, true);
                        }
                    }
                }
...
{%- endautoescape %}", "forms/default/data.txt.twig", "/home/kincsadv/web/ilyaklishin.ru/public_html/user/plugins/form/templates/forms/default/data.txt.twig");
    }
}
