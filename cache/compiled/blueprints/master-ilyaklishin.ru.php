...
return [
    ...
    'timestamp' => 1648404750,
    'checksum' => '0980298123dec96130371ef99ced7e80',
    'files' => [
        ...
        'user/themes' => [
            'themes/striped' => [
                'file' => 'user/themes/striped/blueprints.yaml',
                'modified' => 1648404719
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.striped.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.striped.dropdown',
                'form_field' => false
            ],
            'themes.striped.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.striped.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.striped.color' => [
                'type' => 'text',
                'size' => 'medium',
                'label' => 'Color',
                'default' => 'blue',
        ...
        'nested' => [
            ...
            'themes' => [
                'striped' => [
                    'dropdown' => [
                        'enabled' => 'themes.striped.dropdown.enabled'
                    ],
                    'color' => 'themes.striped.color'
                ]
            ]
        ],
        'dynamic' => [
